...
//!
//! A command-line tool for generating Rust code from DOL files.
//!
//! # Usage
//!
//! ```bash
...
enum TargetLanguage {
    /// Generate Rust code
    Rust,
    // Future: TypeScript, JSON Schema, etc.
}
...
fn main() -> ExitCode {
    ...
    // Add header comment
    generated_code.push_str("// Generated by dol-codegen from Metal DOL declarations\n");
    generated_code.push_str("// Do not edit manually - regenerate from source .dol files\n\n");
